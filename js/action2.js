...
Action.prototype = {
  ...
  show: function(args) {
    ...
    var painter_index = args[0];

    var imgurl = "images/p_" + painter_index + ".png";
    ...
    image.addEventListener('load', function(_image, pp_index) {
      return function(e) {
        ...
        if (pp_index === 1) {
          var $gif = $('<img class="p1_gif" src="images/p_1.gif">');
          $gif.appendTo(p_container);
        }
  ...
  link: function() {
    ...
    window.location.href = 'http://sale.jd.com/m/act/gWow3HMnVxYfXA8E.html';
  },
